...
/**
 * Created by Uclides on 15/03/14.
 */
...
class UploadFile extends Activity implements OnClickListener{
    ...
    public String upLoadServerUri = "http://192.168.0.194:8080";
...
public int senZip() throws IOException {
    HttpClient http = AndroidHttpClient.newInstance("MyApp");
    HttpPost method = new HttpPost("http://url-to-server");

    method.setEntity(new FileEntity(new File("/sdcard/logs/android.zip"), "application/octet-stream"));
